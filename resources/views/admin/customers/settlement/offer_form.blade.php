...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="mb-4 d-flex align-items-center justify-content-between">
        <h4 class="mb-0"><span class="text-muted fw-light">Dashboard / </span> Customer / Settlement Offer Form</h4>
        <div>
            ...
            <div class="row">
                <div class="col-12 col-lg-12">
                    ...
                    <form class="form ajax_form" method="POST"
                        action="{{ route('admin.customer.settlement_offer_save') }}">
                        @csrf
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <div class="row customers">
                                            ...
                                            <div class="col-lg-6 mb-3 ajax-field">
                                                <label class="form-label" for="settlement_offer_last_date">Settlement
                                                    offer last date</label>
                                                <input type="text" class="form-control datepicker"
                                                    id="settlement_offer_last_date"
                                                    placeholder="Settlement offer last date"
                                                    name="settlement_offer_last_date"
                                                    value="{{ isset($edit['settlement_offer_last_date']) ? date('d-m-Y', strtotime($edit['settlement_offer_last_date'])) : '' }}">
                                                <span class="ajax-error" style="color:red;"></span>

                                            </div>
                                            <div class="col-lg-6 mb-3 ajax-field">
                                                <label class="form-label" for="loan_amt">Payment Amount</label>
...
<script>
    $(document).ready(function () {
        ...
        // Event listener for keyup on the settlement_offer input
