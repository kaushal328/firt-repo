<div class="mt-3 ajax-field">
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <?php
            $emi = round($details['settlement']['totalOutstanding'] / $row);
            ...
            <tr>
                ...
                <td>
                    <input type="radio" name="tenure" value="{{ $row }}"
                        class="tenure-radio">
                </td>
            </tr>
            @endforeach
            <tr>
                <td><input type="number" id="tenureInput" class="form-control"
                        placeholder="Enter custom tenure"></td>
                <td id="emiOutput"></td>
                <td id="serviceChargeOutput"></td>
                <td id="totalEmiOutput"></td>
                <td>
                    <input type="radio" name="tenure" id="tenureRadio"
                        class="tenure-radio">
...
<script>
    $(document).ready(function () {
        const totalOutstanding = "{{$details['settlement']['totalOutstanding']}}";
