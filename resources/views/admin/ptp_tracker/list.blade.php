...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <nav aria-label="breadcrumb" class="mb-2 d-flex align-items-center justify-content-between">
            ...
            <a href="{{url('admin/ptp-tracker/form')}}" class="btn btn-primary">Add</a>
        </nav>
        ...
        <div class="">
            ...
            <div class="card mb-3">
                <div class="card-header border-bottom">
                    @include('admin.common.filteration',['restrict'=>2,'url'=>"admin/ptp-tracker"])
                    ...
                    <table class="table">
                        ...
                        <tbody class="table-border-bottom-0">
                            ...
                            <tr data-id="{{ base64_encode($row['id']) }}">
                                ...
                                <td>{{ date("d-m-Y",strtotime($row->ptp_date)) }}</td>
                                <td>{{ $row->status == 1 ? "PTP Done" : "Rescheduled Follow-up" }}</td>
                                <td>
                                    <div class="d-flex align-items-sm-center justify-content-sm-center">
                                        <a class="btn btn-sm btn-icon m-1" href="{{ url('admin/ptp-tracker/form/' . base64_encode($row['id'])) }}">
