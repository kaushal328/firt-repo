    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <nav aria-label="breadcrumb" class="mb-2 d-flex align-items-center justify-content-between">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="{{url('admin/master/bank-type')}}">Lead Source</a>
                </li>
                <li class="breadcrumb-item active">List</li>
            </ol>
            <a href="{{url('admin/master/lead-source/form')}}" class="btn btn-primary">Add lead source</a>
        </nav>
                ...
                <div class="card-header border-bottom">
                    <form>
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <label for="title" class="form-label">Lead source name</label>
                                <input type="text" class="form-control" name="lead_source_name" placeholder="Lead source name" value="<?= isset($lead_source_name) ? $lead_source_name : '' ?>" />
                            </div>
                            <div class="col-lg-3">
                                <button type="submit" class="btn btn-primary mt-4">Search</button>
                                <a class="btn btn-warning mt-4" href="{{url('admin/master/lead-source')}}">Reset</a>
                            </div>
                        </div>
                    </form>
                </div>
                            ...
                            <tr data-id="{{ base64_encode($val['id']) }}">
                                ...
                                <td>
                                    <div class="d-flex align-items-sm-center justify-content-sm-center">
                                        <a class="btn btn-sm btn-icon" href="{{url('admin/master/lead-source/form/'.base64_encode($val['id']))}}"><i class="ti ti-edit text-primary"></i></a>
    ...
    <script>
        ...
        $(document).on('click', '.delete-record', function(e) {
            ...
            if (confirm("Are you sure you want to delete this record?")) {
                const _this = $(this)
                const url = "{{ url('admin/master/lead-source/delete') }}";
                $.post(url, {
