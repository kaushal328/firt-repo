...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <nav aria-label="breadcrumb" class="mb-2 d-flex align-items-center justify-content-between">
            ...
            <a href="{{url('admin/follow-up-tracker/form')}}" class="btn btn-primary">Add</a>
        </nav>
        ...
        <div class="">
            ...
            <div class="card mb-3">
                ...
                @include('admin.common.filteration',['restrict'=>1,'url'=>"admin/follow-up-tracker"])
                </div>
                    ...
                    <table class="table">
                        ...
                        <tbody class="table-border-bottom-0">
                            ...
                            <tr data-id="{{ base64_encode($row['id']) }}">
                                ...
                                <td>{{date("d-m-Y",strtotime($row->follow_up_date)) }}</td>
                                <td>{{ $row->status == 1 ? "Follow-up Done" : "Rescheduled Follow-up" }}</td>
                                <td>
                                    <div class="d-flex align-items-sm-center justify-content-sm-center">
                                        <a class="btn btn-sm btn-icon m-1" href="{{ url('admin/follow-up-tracker/form/' . base64_encode($row['id'])) }}">
    ...
    <script>
        ...
        $(document).on('click', '.delete-record', function(e) {
            ...
            if (confirm("Are you sure you want to delete this record?")) {
                const _this = $(this)
                const url = "{{ url('admin/follow-up-tracker/delete') }}";
                $.post(url, {
